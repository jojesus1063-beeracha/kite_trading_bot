...
# Leveraged replay configuration
RISK_PER_TRADE_PCT = 2.0
MAX_MARGIN_PER_TRADE_PCT = 20.0
...
def create_position(signal):
    ...
    # Leveraged replay:
    #
    # 20% of ₹5,000 capital = ₹1,000 margin budget/trade
    # 5x MIS leverage => up to ₹5,000 stock exposure/trade
    margin_budget = (
        CAPITAL
...
print()
print("=" * 125)
print("EXECUTED FIRST 7 — HISTORICAL EMA9/ATR FILTERED")
print("=" * 125)
