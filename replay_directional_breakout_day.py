...
from directional_breakout_validator import validate_breakout
import price_action as _price_action_module
import entry_quality as _entry_quality_module
_price_action_module.validate_breakout = validate_breakout
...
def configure_replay() -> None:
    ...
    _entry_quality_module.MAX_EMA_DISTANCE_ATR = 2.0
    cfg.MAX_ENTRY_EXTENSION_ATR = float(
        os.environ.get("REPLAY_MAX_ENTRY_EXTENSION_ATR", "1.50")
    )
