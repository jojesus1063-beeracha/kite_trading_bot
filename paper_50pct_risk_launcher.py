...
PAPER_REQUIRE_VALIDATED_BREAKOUT = True
...
PAPER_DELAYED_ENTRY_CONFIRMATION_SECONDS = 0.0
...
def apply_paper_risk_overrides() -> None:
    ...
    cfg.PAPER_REQUIRE_VALIDATED_BREAKOUT = PAPER_REQUIRE_VALIDATED_BREAKOUT
